...
Функция ИмяКомандыРаскрасить() Экспорт
	Возврат "coloring";
КонецФункции
...
Процедура НастроитьКомандыПриложения(Знач Приложение) Экспорт
	...
	Приложение.ДобавитьКоманду(ИмяКомандыРаскрасить(), "КомандаРаскрасить", "Создает файл с раскраской шаблона в формате md");
	//...
