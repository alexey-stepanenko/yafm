...
Процедура Инициализировать(ПараметрыКонструктора) Экспорт
	ИмяРелиза = СтрШаблон(
		"%1-template-tests-%2",
		НастройкаПриложения.ПрефиксИмениФайлаРелиза,
    ...
    ПараметрыКонструктораРасширения.ИдентификаторБлокаКодаРасширения = НастройкаПриложения.БлокТестирования;
...
Функция БлокиКУдалению() Экспорт
    ...
    Результат.Добавить(НастройкаПриложения.БлокРазработки);
    Результат.Добавить(НастройкаПриложения.УдалитьИзРелиза);
...
Процедура ВыполнитьДополнительныеДействия() Экспорт
    ...
    ПутьКФайлуКонфигурации = ОбъединитьПути(КаталогИсходников, НастройкаПриложения.ИмяФайлаКонфигурации);
