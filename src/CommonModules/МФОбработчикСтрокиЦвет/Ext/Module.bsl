...
//    * [1] - Имя цвета.
//    * [2] - Тип описания цвета:
//            * Авто, Auto - Установка авто цвета. Дополнительно см. синтакс помощник ВидЦвета.АвтоЦвет
//            * DEC, 10    - Указание значений компонентов цвета в десятичной системе. 
//                           Например, "190,136,18"
//            * HEX, 16    - Указание значений компонентов цвета в шестнадцатиречной системе. 
//                           Например, "BE8812"
//    * [3] - Необязательное поле. Описание цвета, согласно типу описания. Например:
//
// Пример строки:
// ЦВЕТ	АвтоЦвет	Авто
// ЦВЕТ	Красный	10	255,0,0
// ЦВЕТ	ЦветКнопки	 HEX	BE8812
//
Процедура Обработать(ОписаниеМодификаций, Поля) Экспорт
	...
	СоставПолейСтроки = МФОбработкаСтрокСлужебный.СоставПолейСтроки(
		Поля, 
		"Имя,ТипОписанияЦвета,ПредставлениеЗначения"
	);
...
Процедура ОбработатьТипАвто(ПредставлениеЗначения, ЗначениеЦвета)
	ЗначениеЦвета = Новый Цвет(); // BSLLS:StyleElementConstructors-off
КонецПроцедуры
