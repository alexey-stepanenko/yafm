...
Функция ЗначениеСвойства(ПредставлениеЗначенияСвойства, ОписаниеМодификаций) Экспорт
	...
	Если Не ОписаниеМодификаций.Картинки.Свойство(Идентификатор) Тогда
		// BSLLS:NestedFunctionInParameters-off
		ТекстИсключения = СтрШаблон(
			НСтр("ru='Отсутствует определение картинки ""%1"" в макете модификации формы'"),
	...
	Результат = ОписаниеМодификаций.Картинки[Идентификатор].Значение.Картинка;
