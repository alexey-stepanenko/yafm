...
// РЕЖИМРАЗРАБОТКИ:&После("ОбработатьДанныеФормыДляРежимаРазработки")
// РЕЖИМРАЗРАБОТКИ:Процедура Разработка_ОбработатьДанныеФормыДляРежимаРазработки(Форма, ОписаниеМодификаций)
...
// РЕЖИМТЕСТИРОВАНИЯ:&После("ОбработатьДанныеФормыДляРежимаТестирования")
// РЕЖИМТЕСТИРОВАНИЯ:Процедура Тест_ОбработатьДанныеФормыДляРежимаТестирования(Форма, ОписаниеМодификаций)
