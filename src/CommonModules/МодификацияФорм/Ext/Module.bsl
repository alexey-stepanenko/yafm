...
// РЕЖИМРАЗРАБОТКИ:Процедура Разработка_ОбработатьДанныеФормыДляРежимаРазработки()
...
// РЕЖИМТЕСТИРОВАНИЯ:Процедура Тест_ОбработатьДанныеФормыДляРежимаТестирования()
