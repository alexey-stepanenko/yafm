...
Процедура МодифицироватьФорму(Форма, ПараметрыФормы, Отказ, ИмяМакетаОписанияМодификаций, ГенераторПротокола = Неопределено) Экспорт
	...
	Если ПараметрыФормы.Свойство(МФТестированиеКлиентСерверПовтИсп.ИмяПараметраТестирования()) Тогда
		...
		ДанныеДляТестирования.Вставить("ОписаниеРеквизитов", ОписаниеМодификаций.Реквизиты);
		ДанныеДляТестирования.Вставить("ОписаниеЭлементов", ОписаниеМодификаций.Элементы);
