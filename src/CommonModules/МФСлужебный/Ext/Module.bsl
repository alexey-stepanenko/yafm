...
//
// Параметры:
//  ГенераторПротокола - ОбщийМодуль - Общий модуль, реализующий интерфейс генератора протокола модификации формы.
//                                     Модуль должен содержать следующие процедуры:
...
//                                     При использовании генератора по умолчанию (модуль МФГенераторПротокола)
//                                     возможна настройка работы, см. дополнительно модуль
...
//                                                        подавляется (параметр Отказ процедуры  
//                                                        МодификацияФорм.МодифицироватьФорму устанавливается в
//                                                        Истина).
//
