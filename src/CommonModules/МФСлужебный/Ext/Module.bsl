...
Функция ОписаниеМодификаций(ИмяМакетаОписанияМодификаций, Протокол) Экспорт
	Попытка
		...
		Если
			Не МакетОписанияМодификацийСуществует(ИмяМакетаОписанияМодификаций, МакетОписанияМодификаций, ТекстОшибки)
		Тогда
		...
		МакетОписанияМодификацийРазработка = РегистрыСведений
			.МФМакеты
			.МакетОписанияМодификаций(Протокол.Форма.ИмяФормы, ИмяМакетаОписанияМодификаций)
		;
...
Функция МакетОписанияМодификацийСуществует(ПолноеИмяМакета, Результат = Неопределено, ТекстОшибки) Экспорт
