...
// РЕЖИМРАЗРАБОТКИ:&После("ОбработатьМакетОписанияМодификацийДляРежимаРазработки")
// РЕЖИМРАЗРАБОТКИ:Процедура Разработка_ОбработатьМакетОписанияМодификацийДляРежимаРазработки()
