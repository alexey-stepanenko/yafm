...
Функция МакетОписанияМодификаций(ИмяМакетаОписанияМодификаций) Экспорт
...
Процедура ОбновитьМакетОписанияМодификаций(ИмяМакетаОписанияМодификаций, ТекстМакетаОписанияМодификаций) Экспорт
	УстановитьПривилегированныйРежим(Истина);
	
	Запись = СоздатьМенеджерЗаписи();
	Сжатие = Новый СжатиеДанных(9);
	Запись.ИмяМакета = ИмяМакетаОписанияМодификаций;
	Запись.Макет = Новый ХранилищеЗначения(
		ТекстМакетаОписанияМодификаций,
		Сжатие
	);
	Запись.Записать();
	УстановитьПривилегированныйРежим(Ложь);
