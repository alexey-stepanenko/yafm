...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ТекущаяВерсияРасширения = МФИнструментыРазработчикаКлиентСервер.ВерсияРасширенияТестирования();
КонецПроцедуры
...
Асинх Процедура ЗагрузитьИзРасширения(Команда)
	...
	КонецЦикла;
	Объект.ИмяРасширения = СвойстваРасширения.Имя;
	Объект.ВерсияРасширения = СвойстваРасширения.Версия;
	Объект.ПолныйПутьКФайлуРасширения = ИмяФайлаРасширения;
КонецПроцедуры
