...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПрочитатьНастройкиРаботыСРасширением();
	...
	ВерсияРасширения = МФИнструментыРазработчикаКлиентСервер.ВерсияРасширенияТестирования();
КонецПроцедуры
...
&НаКлиенте
Процедура ПараметрыРаботыСРасширением(Команда)
	...
	КонецЦикла;
	ОповещениеОЗакрытии = Новый ОписаниеОповещения("ПослеЗакрытияФормыНастроекРаботыСРасширением", ЭтаФорма);
	ОткрытьФорму(
		"Обработка.МФГенерацияАвтотестов.Форма.НастройкиРаботыСРасширением",
...
Процедура СоздатьРасширениеСТестами1(Команда)
	...
	ОткрытьФорму(
		"Обработка.МФГенерацияАвтотестов.Форма.РасширениеСТестами",
		ПараметрыФормы,
		, , , , ,
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца
	);
...
&НаСервере
Процедура ПрочитатьНастройкиРаботыСРасширением()
	ИменаПараметров = СтрРазделить(ИменаПараметровДляРаботыСРасширением, ",");
	Для Каждого ИмяПараметра Из ИменаПараметров Цикл
...
&НаСервере
Процедура СохранитьНастройкиРаботыСРасширением(СохраняемыеНастройки)
...
&НаКлиенте
Процедура ПослеЗакрытияФормыНастроекРаботыСРасширением(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	...
	КонецЦикла;
	СохранитьНастройкиРаботыСРасширением(СохраняемыеНастройки);
КонецПроцедуры
...
Функция СвойстваРасширения(ДвоичныеДанные)
	...
	Результат.Вставить("Имя", РасширениеСТестами.Имя);
	Результат.Вставить("Версия", РасширениеСТестами.Версия);
