...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "УспешноеЗавершениеОбновленияРасширенияСТестами" Тогда
		Обработка_УспешноеЗавершениеОбновленияРасширенияСТестами(Параметр);
	ИначеЕсли ИмяСобытия = "ОшибкаОбновленияРасширенияСТестами" Тогда
		Обработка_ОшибкаОбновленияРасширенияСТестами(Параметр);
...
Процедура ЗаполнитьСвойстваТестируемойФормы(ТекущиеДанные)
	// TODO 2025-07-07: Удалить после перехода на ГенераторРасширения
...
Асинх Процедура ПослеУстановкиСвойствГенерацииРасширения(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли РезультатЗакрытия.РежимГенерации = МФИнструментыРазработчикаКлиент.РежимГенерацииРасширенияОбновление() Тогда
		ГенераторРасширения.Открыть();
		ПодключитьОбработчикОжидания("ОбновитьРасширениеСТестами_Выполнение", 0.1, Истина);
	Иначе
		ТекстИсключения = СтрШаблон(
...
Асинх Процедура СоздатьРасширениеСТестами_Выполнение()
	...
	Ждать ГенераторРасширения.СоздатьРасширениеСТестами(ПолныйПутьКФайлуРасширения, Модули);
КонецПроцедуры
...
&НаКлиенте
Процедура Обработка_УспешноеЗавершениеОбновленияРасширенияСТестами(Параметр)
	//ВерсияРасширения = Параметр.ВерсияРасширения;
	//ИмяРасширения = Параметр.ИмяРасширения;
	//ГенераторРасширения.ЗакрытьФорму();
	//ПоказатьПредупреждение(
...
&НаКлиенте
Процедура Обработка_ОшибкаОбновленияРасширенияСТестами(Параметр)
	//ПолныйПутьКФайлуРасширения = "";
	//ГенераторРасширения.ЗакрытьФорму();
	//
	//ВызватьИсключение Параметр;
