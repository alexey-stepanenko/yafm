...
Асинх Процедура СоздатьРасширение(Команда)
	...
	// TODO 2025-05-05: Удалить после создания процедуры формирования исходников
	БазовыйКаталог = "/home/alexey/repo/yafm/tmp/cfe_test_src";
	БазовыйКаталог = "C:\repo\yafm\tmp\cfe_test_src";
...
Асинх Функция ПодготовитьИнформационнуюБазу()
	...
	Если ВидИнформационнойБазы = 0 Тогда
		...
		ПутьКВременнойФайловойИБ = "/home/alexey/repo/yafm/tmp/temp_base_for_cfe";
