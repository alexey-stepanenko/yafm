...
Функция Идентификаторы() Экспорт
	...
	Идентификаторы.Добавить("СВОЙСТВОКОМАНДЫ");
	
	Возврат Идентификаторы;
КонецФункции

// Обработчик строки, описывающий свойство команды формы
//
// Параметры:
...
//
// Пример строки:
// СВОЙСТВОКОМАНДЫ	НоваяКоманда	Подсказка	Подсказка новой команды
//
