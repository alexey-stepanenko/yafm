...
Функция Идентификаторы() Экспорт
	...
	Идентификаторы.Добавить("ДЕЙСТВИЕКОМАНДЫ");
	
	Возврат Идентификаторы;
КонецФункции

// Обработчик строки, описывающий действие команды
//
// Параметры:
...
//    * [1] - Имя команды.
//    * [2] - Имя процедуры-обработчика действия.
//
// Пример строки:
//  ДЕЙСТВИЕКОМАНДЫ	НоваяКоманда1	Действие
//
Процедура Обработать(ОписаниеМодификаций, Поля) Экспорт
	...
	СоставПолейСтроки = МФОбработкаСтрокСлужебный.СоставПолейСтроки(Поля, "Имя,Действие");
	...
	Описание.Действие = СоставПолейСтроки.Действие;
КонецПроцедуры
