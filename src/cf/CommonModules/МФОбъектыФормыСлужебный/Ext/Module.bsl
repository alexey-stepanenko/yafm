...
Функция НовыйОписаниеСвойствОбъектаФормы() Экспорт
	...
	Результат.Вставить("СвойстваНедоступныеНаКлиенте", Новый Массив);
...
Процедура ДобавитьОписаниеСвойстваОбъектаФормы(ОписанияСвойствЭлементов, ИменаСвойстваСтрокой, ИмяРаздела, ЗависимостиТиповСвойства, ЗначенияТиповСвойства) Экспорт
...
Процедура СформироватьСвойстваНедоступныеНаКлиенте(ОписанияСвойств, СвойстваНедоступныеНаКлиенте) Экспорт
	Для Каждого Элемент Из СвойстваНедоступныеНаКлиенте Цикл
		...
		Для Каждого Синоним Из Синонимы Цикл
			ОписанияСвойств.СвойстваНедоступныеНаКлиенте.Добавить(ВРег(Синоним));
		КонецЦикла;
	КонецЦикла;
КонецПроцедуры
...
Функция Разделы()
	...
	Результат.Вставить(МФПовтИсп.РазделПредставление(), Новый Массив);
