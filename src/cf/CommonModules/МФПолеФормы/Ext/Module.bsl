...
Процедура ЗаполнитьРазделОсновные(ОписанияСвойств, СинонимыСвойств, Зависимости) Экспорт
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.РежимПароля, Раздел, ЗависимостьРежимПароля, МФПовтИсп.ТипБулевоНеопределено());
	
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.МногострочныйРежим, Раздел, Зависимости.ВидПолеВвода, МФПовтИсп.ТипБулевоНеопределено());
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.РасширенноеРедактирование, Раздел, Зависимости.ВидПолеВвода, МФПовтИсп.ТипБулевоНеопределено());
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.ФорматРедактирования, Раздел, ЗависимостьФорматРедактирования, Тип("Строка"));
...
Процедура ЗаполнитьРазделИспользование(ОписанияСвойств, СинонимыСвойств, Зависимости) Экспорт
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.КнопкаСпискаВыбора, Раздел, Зависимости.ВидПолеВвода, МФПовтИсп.ТипБулевоНеопределено());
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.СписокВыбора, Раздел, ЗависимостьСписокВыбора, Тип("СписокЗначений"));
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.РежимВыделенияИнтервалов, Раздел, Зависимости.ВидПолеДиаграммыГанта, Тип("РежимВыделенияИнтерваловДиаграммыГанта"));
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.Ориентация, Раздел, ЗависимостьОриентация, ТипыОриентация);
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.НачалоПериодаОтображения, Раздел, Зависимости.ВидПолеКалендаря, Тип("Дата"));
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.КонецПериодаОтображения, Раздел, Зависимости.ВидПолеКалендаря, Тип("Дата"));
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.ВыделятьОтрицательные, Раздел, ЗависимостьВыделятьОтрицательные, МФПовтИсп.ТипБулевоНеопределено());
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.ОтображатьВШапке, Раздел, ЗависимостьОтображатьВШапке, Тип("Булево"));
КонецПроцедуры
...
Процедура ЗаполнитьРазделРасположение(ОписанияСвойств, СинонимыСвойств, Зависимости) Экспорт
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.АвтоМаксимальнаяШирина, Раздел, ЗависимостьАвтоМаксимальнаяШиринаВысота, Тип("Булево"));
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.АвтоМаксимальнаяВысота, Раздел, ЗависимостьАвтоМаксимальнаяШиринаВысота, Тип("Булево"));
	...
	ТипыРастягивать.Добавить(Тип("Булево"));
	ТипыРастягивать.Добавить(Тип("Булево"));
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.РастягиватьПоГоризонтали, Раздел, ЗависимостьРастягивать, ТипыРастягивать);
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.РастягиватьПоВертикали, Раздел, ЗависимостьРастягивать, ТипыРастягивать);
	...
	МФЭлементыФормыСлужебный.ДобавитьОписаниеСвойстваЭлементаФормы(ОписанияСвойств, СинонимыСвойств.ВысотаЗаголовкаЭлемента, Раздел, ЗависимостьВысотаЗаголовкаЭлемента, Тип("Число"));
КонецПроцедуры
...
Процедура ЗаполнитьСвойстваЭлементаНедоступныеНаКлиенте(ОписанияСвойств, СинонимыСвойствЭлементов) Экспорт
	...
	//Свойства.Добавить(СинонимыСвойствЭлементов.ПутьКДаннымПодвала);
