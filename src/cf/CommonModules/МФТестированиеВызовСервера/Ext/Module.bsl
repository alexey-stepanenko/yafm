...
Функция РеквизитСуществуетВДанныхТестирования(ИмяФормы, ИмяРеквизита, Контекст) Экспорт
	...
	РеквизитДляТестирования = ДанныеДляТестированияФормы.Реквизиты.Получить(ИмяРеквизита);
	Если РеквизитДляТестирования = Неопределено Тогда
		Результат =Ложь;
	КонецЕсли;
...
Функция ПолучитьСвойстваОбъектовНедоступныеНаКлиентеИзДанныхТестирования(АдресДанныхДляТестирования, ИмяКоллекции) Экспорт
	Результат = Неопределено;
	
	ДанныеДляТестирования = ПолучитьИзВременногоХранилища(АдресДанныхДляТестирования);
	Результат = ДанныеДляТестирования[ИмяКоллекции];
...
Функция ЭтоСвойствоКомандыФормыНедоступноеНаКлиенте(ИмяСвойства, ИмяСвойстваДляПолученияЗначения) Экспорт
	Результат = Ложь;
	
	Нашли = МФОбъектыФормыПовтИсп
	...
	Если Нашли <> Неопределено Тогда
		Результат = Истина;
		ИмяСвойстваДляПолученияЗначения = МФОбъектыФормыПовтИсп
			.ОписанияСвойствКомандФормы()
			.СоответствиеСвойств
...
Функция ЭтоСвойствоЭлементаФормыНедоступноеНаКлиенте(ТипЭлементаФормы, ИмяСвойства, ИмяСвойстваДляПолученияЗначения) Экспорт
	Результат = Ложь;
...
Функция ЗначениеСтандартногоПеречисления(ИмяТипа, ЗначениеСтрокой) Экспорт
	Результат = МФПовтИсп
		.ЗначенияСтандартныхПеречислений()
		.Значения
		.Получить(Тип(ИмяТипа))
		.Получить(МФОбработкаСтрокСлужебный.Идентификатор(ЗначениеСтрокой))
	;
...
Функция ДанныеТестированияСодержатТип(ИмяФормы, ИмяРеквизита, ПроверяемыйТип, Контекст)
	...
	ОписаниеТиповРеквизита = РеквизитДляТестирования.ТипЗначения;
