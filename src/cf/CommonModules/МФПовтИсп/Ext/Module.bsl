...
Функция РазделПредставление() Экспорт 
	Возврат НСтр("ru='Представление'");
КонецФункции
...
Функция ОбработчикиТиповСтрокОписанияМодификации() Экспорт
	...
	ДобавитьОбработчикДанных(Результат, МФОбработчикСтрокиСвойствоКоманды);
	
	// Устаревшие обработчики. Удалить в версии 1.2.xxx.xxx
	// Вместо этих обработчиков использовать МФОбработчикСтрокиСвойствоКоманды
	// {{
	...
	// Обработка картинки
	ДобавитьОбработчикДанных(Результат, МФОбработчикСтрокиКартинка);
	
	// Обработка связей параметров выбора
	ДобавитьОбработчикДанных(Результат, МФОбработчикСтрокиСвязиПараметровВыбора);
	ДобавитьОбработчикДанных(Результат, МФОбработчикСтрокиСвязьПараметраВыбора);
