...
Процедура ОбработатьДанныеФормыДляСозданияМодификации(Форма, ОписаниеМодификаций) Экспорт
	...
	Для Каждого ЭлементКоллекции Из Форма.Элементы Цикл
		ОписаниеЭлемента = НовыйОписаниеЭлемента();
		ОписаниеЭлемента.Имя = ЭлементКоллекции.Имя;
		ОписаниеЭлемента.Тип = ТипЗнч(ЭлементКоллекции);
	...
	ДанныеДляСозданияМодификации.Вставить("ЭлементыФормы", ЭлементыФормы);
