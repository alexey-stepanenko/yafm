...
// РЕЖИМ РАЗРАБОТКИ: НАЧАЛО БЛОКА
	...
	МФИнструментыРазработчика.ПроверитьНаБезопасныйРежим(ЭтоБезопасныйРежим);
	Если ЭтоБезопасныйРежим Тогда
		ПоказатьПредупреждение(
			,
			НСтр("ru='Инструменты разработчика запущены в безопасном режиме. Функциональность будет нарушена!'"),
			30,
