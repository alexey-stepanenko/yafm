...
// РЕЖИМРАЗРАБОТКИ:&После("ПриНачалеРаботыСистемы")
...
// НАЧАЛО БЛОКА РЕЖИМ РАЗРАБОТКИ
	РазличающиесяМакетыОписанийМодификаций = МФИнструментыРазработчика.РазличающиесяМакетыОписанийМодификаций();
	Если
		РазличающиесяМакетыОписанийМодификаций.МакетыКИзменению.Количество()
		+ РазличающиесяМакетыОписанийМодификаций.МакетыКУдалению.Количество()
		> 0
	Тогда
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"ПослеПоказаВопросаОбОткрытииФормыАктуализацииМакетов",
